...
import imagemIaraGames from './images/img2.jpg';
import imagemJardimental from './images/img1.jpg';
import imagemSiteInstitucional from './images/img5.png';
import imagemSportsX from './images/img4.jpg';
import fotoPerfil from './images/perfil.webp';
    ...
    <>
      <main>
        <div className="conteudo">
          ...
          <ul className="redes">
            <li>
              <a href="mailto:guicunhasou@gmail.com">Email</a>
            </li>
            <li>
              <a
                href="https://www.linkedin.com/in/guicunhasou/"
                target="_blank"
            ...
            <li>
              <a
                href="https://github.com/guicunhasou"
                target="_blank"
                rel="noopener noreferrer"
              >
                GitHub
            ...
            <li>
              <a
                href="https://www.behance.net/guicunhasou"
                target="_blank"
                rel="noopener noreferrer"
              >
                Behance
